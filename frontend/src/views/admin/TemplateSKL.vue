<template>
  <div class="bg-[#f4f7f6] min-h-screen p-4 font-sans text-sm">
    <div class="max-w-7xl mx-auto bg-white shadow-sm border border-gray-200 p-6 rounded-sm">
      ...
      <!-- FOOTER TOGGLES - HANYA FOTO SISWA -->
...
// HANYA FOTO SISWA (QR CODE & NAMA WALI DIHAPUS)
const footerToggles = [
...
const fetchTemplate = async () => {
  ...
  try {
    ...
    if (res.data && res.data.data) {
      ...
      form.value.width_ttd = data.width_ttd || 100
      ...
      form.value.pakai_foto = !!data.pakai_foto
      ...
      // pakai_ttd_qrcode ← DIHAPUS
      // pakai_nama_wali ← DIHAPUS
    }
  } catch (err) {
