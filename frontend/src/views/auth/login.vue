      ...
      <div class="w-full md:w-1/2 bg-white p-8 md:p-24 flex flex-col justify-center">
        ...
        <form v-if="!showOTPForm" @submit.prevent="handleLogin" class="space-y-7 transition-all duration-500">
          <div class="space-y-3">
            ...
            <input v-model="email" type="email" required class="w-full px-6 py-5 rounded-2xl border-2 border-slate-100 bg-slate-50 focus:outline-none focus:ring-4 focus:ring-slate-900/5 focus:border-slate-900 focus:bg-white transition-all duration-300 text-sm font-bold text-slate-900" placeholder="">
          </div>
